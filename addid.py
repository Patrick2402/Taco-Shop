...
def add_ingredient(tacos):  # adding an ingredients to your taco
    while 1:
        ...
        items_to_add = input('\nWhat do u want to add?\n'
                             'I want to add: ')
        if not items_to_add in ingrediens.dict_of_ingrediens:
            ...
            if items_to_add not in tacos.list_of_ingrediens:
                ...
                print("Ups you have added this ingredient")


def remove_ingredient(tacos):
    print('Which ingredient do u want to remove?')
    name_of_ingredient = input('My choice: ')
    if name_of_ingredient in tacos.list_of_ingrediens:
